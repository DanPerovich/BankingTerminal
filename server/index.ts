...
(async () => {
  ...
  // Use different ports for local vs Replit environment
  // Port 5000 conflicts with macOS ControlCenter on local machines
  const port = process.env.REPLIT_ENVIRONMENT ? 5000 : 3000;
